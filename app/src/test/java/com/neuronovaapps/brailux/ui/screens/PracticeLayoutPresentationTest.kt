...
class PracticeLayoutPresentationTest {
    ...
    fun `daily practice badge and daily challenge badge resource identifiers are configured`() {
        val dailyBadge = com.neuronovaapps.brailux.R.string.daily_practice_badge
        val dailyBadgeAccessibility = com.neuronovaapps.brailux.R.string.daily_practice_badge_accessibility
        val challengeBadge = com.neuronovaapps.brailux.R.string.daily_challenge_badge
        val challengeBadgeAccessibility = com.neuronovaapps.brailux.R.string.daily_challenge_badge_accessibility
