...
class DailyPracticeFeatureTest {
    ...
    fun requirement15_resourceIdsAreConfiguredForDailyIdentity() {
        ...
        val dailySubtitle = com.neuronovaapps.brailux.R.string.daily_practice_header_subtitle
        val dailyBadge = com.neuronovaapps.brailux.R.string.daily_practice_badge
        val dailyBackHome = com.neuronovaapps.brailux.R.string.daily_practice_back_to_home
        val level1Title = com.neuronovaapps.brailux.R.string.practice_level_1_title
        val level1Completed = com.neuronovaapps.brailux.R.string.practice_level_completed
