...
class DailyChallengeFeatureTest {
    ...
    fun requirement15_resourceIdsAreConfiguredForDailyChallengeIdentity() {
        val challengeCompleted = com.neuronovaapps.brailux.R.string.daily_challenge_completed
        val challengeTitle = com.neuronovaapps.brailux.R.string.daily_challenge_header_title
        val challengeSubtitle = com.neuronovaapps.brailux.R.string.daily_challenge_header_subtitle
        val challengeBadge = com.neuronovaapps.brailux.R.string.daily_challenge_badge
        val challengeBackHome = com.neuronovaapps.brailux.R.string.daily_challenge_back_to_home
        val dailyTitle = com.neuronovaapps.brailux.R.string.daily_practice_header_title
        val dailyCompleted = com.neuronovaapps.brailux.R.string.daily_practice_completed
